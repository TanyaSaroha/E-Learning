...
def loading():
    import csv
    data1=csv.reader(open('act_pred_250.csv','rb'))
    user,y_true,y_pred =[],[],[]
    error1 = []
    data1.next()
    user_now = 'Jaya'
    ...
    data2=csv.reader(open('act_pred_500.csv','rb'))
    user,y_true,y_pred =[],[],[]
    error2 = []
    data2.next()
    user_now = 'Jaya'
    ...
    data3=csv.reader(open('act_pred_800.csv','rb'))
    user,y_true,y_pred =[],[],[]
    error3 = []
    data3.next()
    user_now = 'Jaya'
    ...
    plt.title('This graph depicts the MAE for different number of ratings for CF')
